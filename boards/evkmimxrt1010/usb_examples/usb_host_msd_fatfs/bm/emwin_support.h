...
#define BOARD_LCD_SPI_BAUDRATE 1000000U /*! Transfer baudrate */
...
#define BOARD_LCD_DC_GPIO_PIN 11U /*! LCD data/command pin */
...
#define GUI_NUMBYTES 0x4000 /*! Amount of memory assigned to the emWin library */
